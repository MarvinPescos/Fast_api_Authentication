...
export function loginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        error.response?.data?.detail === "2FA_REQUIRED" ||
        error.response?.status === 403
      ) {
        setRequires2FA(true);
        clearError();
      }
      // Other errors are handled by authHooks
    }
  };
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            {/* 2FA Code Input - Shows only if 2FA is required */}
            {requires2FA && (
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <label
                      ...
                      className="block text-xs font-medium text-blue-700 mb-2"
                    >
                    ...
                    <input
                      ...
                      maxLength={6}
                      placeholder="000000"
                      className="w-full px-4 py-2 border border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-lg tracking-widest font-mono"
            ...
            <button
              type="submit"
              disabled={
                isLoading || (requires2FA && twoFactorCode.length !== 6)
              }
